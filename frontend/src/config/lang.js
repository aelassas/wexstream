...
export const strings = new LocalizedStrings({
	en: {
		...
		TOS_PREAMBLE_P2: 'Wexstream was developed using most recent and performant technologies, which allows the platform to handle a large number of conferences and participants.',
		...
		TOS_SUBSCRIBING_4: 'In the event that the user provides false, inaccurate, outdated or incomplete data, Wexstream will be entitled to suspend or close his account and to refuse him, in the future, access to all or part of the services.',
		...
		TOS_LITIGATIONS: 'Wexstream is not responsible for the collaboration between the broadcasters and the users, but Wexstream may be able to help resolve any dispute.',
		...
		TOS_PRIVACY_1: 'Wexstream protects your live and hosted content using TLS encryption and end-to-server/transit encryption. Plus, added privacy settings passwords and meeting locks puts the control in your hands.',
		TOS_PRIVACY_2: "Wexstream is committed to using all means to ensure the security and privacy of users' personal data.",
		...
		TOS_MODIFICATION_1: "Wexstream reserves the right to modify all or part of these conditions of use.",
		TOS_MODIFICATION_2: "Wexstream will inform the user of the modifications made to these general conditions as soon as they are posted on the platform.",
		TOS_LAW_TITLE: 'APPLICABLE LAW AND COMPETENT JURISDICTION',
		TOS_LAW: 'Any dispute relating to the formation of these terms of service, conclusion, interpretation and/or execution falls under the exclusive jurisdiction of the courts.',
		...
		TECHNICAL_ISSUES: 'For technical issues and bug reporting, contact...',
		OTHER_REQUESTS_TITLE: 'Other Requests',
		OTHER_REQUESTS: 'For requests related to the platform or any other request, contact...',
		LANGUAGE: 'Language',
		NO_RESULT: 'No result',
	...
	fr: {
		...
		TOS_PREAMBLE_P2: 'Wexstream a été développé en utilisant les technologies les plus récentes et les plus performantes, ce qui permet à la plateforme de gérer un grand nombre de conférences et de participants.',
		...
		TOS_LAW: "Tout litige relatif à la formation de ces présentes conditions générales d'utilisation, conclusion, interprétation et/ou exécution relève de la compétence exclusive des juridictions dans le ressort de la cour d'appel.",
		...
		TECHNICAL_ISSUES: 'Pour les problèmes techniques et les signalement de bogues, contactez...',
		OTHER_REQUESTS_TITLE: 'Autres Demandes',
		OTHER_REQUESTS: 'Pour les demandes relatives à la plateforme ou toute autre demande, contactez...',
		LANGUAGE: 'Langue',
