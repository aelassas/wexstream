...
export const strings = new LocalizedStrings({
	en: {
		...
		DONATE_TITLE: 'Donate',
		TERADEV: 'Teradev',
		// DONATE_1: "  is the company behind Wexstream. Due to COVID-19 pandemic, Teradev decided to create a free video conferencing platform focused on security and privacy. Teradev relies on donations to keep the platform running, to ensure its development, hosting and maintenance.",
		// DONATE_2: "The project was developed using most recent and performant technologies. Wexstream is hosted on Teradev's own servers. Teradev ensures the maintenance of the platform including fixing bugs, database maintenance, handling security and privacy, handling conflicts between users, applying the terms of use and handling all requests regarding the platform.",
		// DONATE_3: 'The hosting and maintenance of Wexstream costs to Teradev about $1,500/year. To keep Wexstream running, please consider making a donation to help develop, host and maintain the platform.',
		DONATE: 'To keep Wexstream running, please consider making a donation to help develop, host and maintain the platform.',
		PAYPAL: 'PayPal',
		PATREON: 'Patreon',
	...
	fr: {
		...
		TERADEV: 'Teradev',
		// DONATE_1: " est la société qui a créé Wexstream. En raison de la pandémie de COVID-19, Teradev a décidé de créer une plateforme de vidéoconférence gratuite axée sur la sécurité et la confidentialité. Teradev s'appuie sur les dons pour faire fonctionner la plateforme, assurer son développement, son hébergement et sa maintenance.",
		// DONATE_2: "Le projet a été développé en utilisant les technologies les plus récentes et les plus performantes. Wexstream est hébergé sur les propres serveurs de Teradev. Teradev assure la maintenance de la plateforme incluant la correction de bugs, la maintenance de la base de données, la gestion de la sécurité et de la confidentialité, la gestion des conflits entre utilisateurs, l'application des conditions d'utilisation et le traitement de toutes les demandes concernant la plateforme.",
		// DONATE_3: "L'hébergement et la maintenance de Wexstream coûtent à Teradev environ 1 500 $/an. Pour que le projet Wexstream continue, veuillez envisager de faire un don pour aider au développement, à l'hébergemenent et à la maintenance de la plateforme.",
		DONATE: "Pour que le projet Wexstream continue, veuillez envisager de faire un don pour aider au développement, à l'hébergemenent et à la maintenance de la plateforme.",
		PAYPAL: 'PayPal',
		PATREON: 'Patreon',
		BUY_ME_A_COFFEE: 'Buy Me a Coffee',
		LIBERAPAY: 'Liberapay',
	...
	ar: {
		//#region Translated
		APP_TITLE: 'وكس ستريم -  مؤتمرات آمنة',
		APP_DESCRIPTION: 'ابقو على اتصال مع عائلتكم أو أصدقائكم أو زملائكم. مؤتمرات فيديو تتكيف بكفاءة مع حاجاتكم مجانا.',
		FULL_NAME: 'الإسم الكامل',
		INVALID_EMAIL: 'عنوان البريد الإلكتروني غير صالح',
		CONFIRM_PASSWORD: 'تأكيد كلمة السر',
		SIGN_UP: 'إشتراك',
		SIGN_UP_HEADING: 'الإشتراك',
		ERROR_IN_RECAPTCHA: 'المرجو ملء الكابتشا للمتابعة.',
		ERROR_IN_PASSWORD: 'يجب أن لا تقل كلمة السر عن 6 أحرف على الأقل.',
		PASSWORDS_DONT_MATCH: "كلمتي السر غير متطابقة.",
		ERROR_IN_SIGN_UP: 'وقع خطأ عند التسجيل.',
		ERROR_IN_SIGN_IN: 'لا يمكننا تسجيل الدخول إلى حسابكم.',
		ERROR_IN_PROFILE: 'خطأ عند حفظ ملف التعريف.',
		EMAIL: 'البريد إلكتروني',
		PASSWORD: 'كلمة السر',
		AUTHENTICATING: 'تحقيق...',
		VALIDATE_EMAIL: "تم إرسال بريدا إلكترونيا للتحقق من بريدكم الإلكتروني. المرجو فتح صندوق بريدكم الإلكتروني و الضغط على رابط التحقق. ستنتهي صلاحيت ذالك الرابط بعد يوم. إذا لم تتلقوا بريدً التحقق، إضغطوا على إعادة الإرسال.",
		RESEND: 'إعادة الإرسال',
		VALIDATION_EMAIL_SENT: 'تم إرسال بريدا إلكترونيا للتحقق من بريدكم إلكتروني.',
		VALIDATION_EMAIL_ERROR: 'حدث خطأ أثناء إرسال البريد الإلكتروني للتحقق.',
		SAVE: 'حفظ',
		CANCEL: 'إلغاء',
		SEARCH_PLACEHOLDER: 'بحث...',
		SIGN_IN: 'دخول',
		SIGN_IN_WITH_GOOGLE: 'دخول عبر Google',
		SIGN_IN_WITH_EMAIL: 'دخول عبر البريد',
		...
		EMAIL_SHARE: 'نشر عبر البريد الإلكتروني',
		FACEBOOK: 'نشر عبر فيسبوك',
		TWITTER: 'نشر عبر تويتر',
		WHATSAPP: 'نشر عبر واتساب',
		SUBJECT: 'الإلتحاق بالمحاضرة ',
		PROFILE_HEADING: 'الملف الشخصي',
		USER_UPDATE: 'تم حفظ الملف الشخصي بنجاح.',
		USER_UPDATE_ERROR: 'حدث خطأ أثناء حفظ الملف الشخصي.',
		DELETE_ACCOUNT: 'حذف الحساب',
		DELETE_ACCOUNT_ERROR: 'حدث خطأ أثناء حذف الحساب.',
		DELETE_ACCOUNT_CONFIRM: 'حذف الحساب أمرًا نهائيًا لا رجوع فيه وسيؤدي إلى إزالة كل المحتوى. هل أنت متأكد؟',
		SPASSWORD_RESET_HEADING: 'تغيير كلمة السر',
		CURRENT_PASSWORD: 'كلمة السر الحالية',
		NEW_PASSWORD: 'كلمة السر الجديدة',
		CURRENT_PASSWORD_ERROR: 'كلمة السر خاطئة',
		NEW_PASSWORD_REQUIRED_ERROR: 'كلمة السر الجديدة واجبة',
		PASSWORD_UPDATE: 'تم تغيير كلمة السر بنجاح.',
		PASSWORD_UPDATE_ERROR: 'حدث خطأ أثناء تغيير كلمة السر.',
		CHANGE_LANGUAGE_ERROR: 'حدث خطأ أثناء تغيير اللغة.',
		NETWORK: 'الشبكة',
		CONNECT: 'إرتباط',
		DISCONNECT: 'قطع',
		CONNECTION_PENDING: 'الإرتباط معلق',
		CONNECTED: 'مرتبط',
		CONNECTION_CANCELED: 'تم إلغاء طلب الإرتباط بنجاح.',
		CONNECTION_DELETED: 'قطع الإرتباط بنجاح.',
		CONNECTION_DELETE_ERROR: 'حدث مشكل أثناء قطع الارتباط.',
		SEND_MESSAGE: 'إرسال',
		CONNECTION_REQUEST_SENT: 'تم إرسال طلب الإرتباط.',
		CONNECTION_REQUEST_ERROR: 'حدث مشكل أثناء إرسال طلب الإرتباط.',
		CONNECTION_REQUEST_NOTIFICATION: 'أرسل لك طلب إرتباط.',
		APPROVE: 'موافقة',
		DECLINE: 'رفض',
		CONNECTION_APPROVE: 'تم الإرتباط بنجاح.',
		CONNECTION_APPROVE_ERROR: 'حدث خطأ أثناء الموافقة على طلب الإرتباط.',
		CONNECTION_DECLINE: 'تم رفض طلب الإرتباط بنجاح.',
		CONNECTION_DECLINE_ERROR: 'حدث مشكل أثناء رفض طلب الإرتباط.',
		NOTIFICATION_DELETE: 'تم حذف الإعلان بنجاح.',
		NOTIFICATION_DELETE_ERROR: 'حدث مشكل أثناء حذف الإعلان.',
		NO_NOTIFICATION: 'ليس هناك إعلان.',
		CONNECTION_APPROVE_NOTIFICATION: 'أنتم الآن مرتبطين بـ',
		CONNECTION_REJECT_NOTIFICATION: 'رفض طلب الإرتباط بكم.',
		CONNECTIONS: 'العلاقات',
		NO_CONNECTION: 'ليس لديكم علاقة.',
		AT: 'في',
		TOS_PREAMBLE_TITLE: 'مقدمة',
		TOS_PREAMBLE_P1: 'ابقو على اتصال مع عائلتكم أو أصدقائكم أو زملائكم. مؤتمرات فيديو تتكيف بكفاءة مع حاجاتكم مجانا.',
		TOS_PREAMBLE_P2: 'يتم استضافة المنصة على خادم عالي الأداء وآمن مع عرض نطاق ترددي كبير وتم تطويره باستخدام أحدث التقنيات، مما يسمح للمنصة بمعالجة عدد كبير من المؤتمرات والمشاركين.',
		TOS_PREAMBLE_1: 'عدد غير محدود من المستخدمين: لا توجد قيود على عدد المستخدمين أو المشاركين في المؤتمر. قوة المنصة هي العامل المقيّد الوحيد.',
		TOS_PREAMBLE_2: 'إعدادات الخصوصية وكلمات المرور وأقفال الاجتماعات تضع التحكم بين أيديكم.',
		TOS_PREAMBLE_3: 'غرف محمية: تحكم في الوصول إلى مؤتمراتك بكلمة مرور.',
		TOS_PREAMBLE_4: 'مشاركة الشاشة و المراسلة والعديد من الميزات المفيدة.',
		TOS_PREAMBLE_5: 'أحدث تقنيات التعمية.',
		TOS_PREAMBLE_6: 'المؤتمرات محمية باستخدام تقنيات حديثة.',
		TOS_PREAMBLE_7: 'جودة عالية: يتم تسليم الصوت والفيديو بوضوح عبر Opus و VP8.',
		TOS_PREAMBLE_8: 'جاهز للويب: لا يلزم تنزيل من طرف أصدقائكم للانضمام إلى المؤتمرات. ما عليكم سوى مشاركة عنوان URL الخاص بالمؤتمر مع الآخرين للابتداء.',
		TOS_PREAMBLE_9: 'جاهزة للجوال: يمكن الوصول إلى المنصة و استخدامها عبر جميع الأجهزة.',
		TOS_PREAMBLE_10: 'لا يتم إعادة بيع البيانات الشخصية للمستخدمين ولا يتم نقلها.',
		TOS_PREAMBLE_11: 'يحق للمستخدمين الوصول إلى بياناتهم الشخصية وتعديلها وتصحيحها وحذفها.',
		TOS_SUBSCRIBING_TITLE: 'التسجيل',
		TOS_SUBSCRIBING_1: 'لإستعمال الخدمات، يجب على المستخدم إنشاء حساب عن طريق التسجيل مجانًا.',
		TOS_SUBSCRIBING_2: 'يجب على المستخدم تقديم معلومات صحيحة يتعهد بتحديثها على الفور في حالة التغيير.',
		TOS_SUBSCRIBING_3: 'الدخول إلى المنصة محمي بواسطة بريد الإكتروني وكلمة سر يختارهما المستخدم عند التسجيل. المستخدم مسؤول عن استخدام  بريده الإكتروني وكلمة السرالخاصة به، وهو الضامن الوحيد لهما، وكذلك أي استخدام لحسابه.',
		TOS_SUBSCRIBING_4: 'في حالة قيام المستخدم بتقديم معلومات خاطئة أو غير صحيحة أو قديمة أو غير كاملة، يحق لنا إغلاق حسابه ورفض وصوله في المستقبل إلى كل الخدمات أو جزء منها.',
		TOS_SERVICES_TITLE: 'الخدمات',
		TOS_SERVICES_1: 'بمجرد التسجيل، يمكن للمستخدم الاستفادة من الخدمات التالية:',
		TOS_SERVICES_2: 'سهولة التواصل بين أعضاء المنصة؛',
		TOS_SERVICES_3: 'توفير أدوات البث المباشر؛',
		TOS_SERVICES_4: 'توفير أدوات الاتصال بين أعضاء المنصة؛',
		TOS_SERVICES_5: 'تشتغل المنصة بالشكل التالي:',
		TOS_SERVICES_6: 'يقوم المستخدم بإنشاء شبكة عن طريق الاتصال بالمستخدمين الآخرين.',
		TOS_SERVICES_7: 'يبث المستخدم الدورات أو الندوات أو الصوتيات أو المررئيات عبر البث المباشر عبر الإنترنت في دائرة خاصة أو عامة.',
		TOS_SERVICES_8: 'عند البث، يحصل المستخدم على عنوان يمكنه مشاركته لدعوة المستخدمين للانضمام إليه و متابعت البث.',
		TOS_SERVICES_9: "عند البث، يتم إشعار شبكة المستخدم.",
		TOS_ACCESS_TITLE: 'الوصول للخدمات',
		TOS_ACCESS_1: 'الوصول إلى المنصة والخدمات خإص حصريًا بالمستخدمين المسجلين. يبث المستخدمون محتويات تعليمية أو محاضرات أو صوتيات أو مرئيات  أو بث مباشر عبر الإنترنت  أو يحضرون دورات تعليمية أو حلقات أو مؤتمرات عبر الإنترنت، ويتمتعون بإمكانية الوصول إلى موارد معلوماتية عبر المنصة و الحصول على الوسئل التي تسمح بالتواصل بيهم عبر المنصة.',
		TOS_ACCESS_2: 'المنصة مفتوحة كل يوم وطوال أيام الأسبوع لجميع المستخدمين. نحتفظ بالحق، دون إشعار أو تعويض، في إغلاق الحساب الأساسي بشكل مؤقت أو دائم أو خدمة واحدة أو أكثر لإجراء أي تحديث أو تغييرات في أساليب التشغيل، دون أن تكون هذه القائمة شاملة. نحتفظ بالحق في إجراء أي تعديلات وتحسينات على المنصة والخدمات التي نجدها ضرورية أو مفيدة للتشغيل السليم للمنصة وخدماتها.',
		TOS_LITIGATIONS_TITLE: 'الدعاوى',
		TOS_LITIGATIONS: 'لسنا مسؤولين عن الدعاوى أو المخالفات أو النزاعات بين المذيعين والمستخدمين أو بين المستخدمين فيما بينهم، ولكن يمكننا المساعدة في حل النزاعات.',
		TOS_COMMITMENTS_TITLE: 'الإلتزامات',
		TOS_COMMITMENTS: 'يتعهد المستخدمون بالاستخدام العادل للمنصة والخدمات والامتناع صراحة عن التحايل على الخدمات أوالنظام أو شروط أو سياسات المنصة. وبالتالي، يُحظر على أي مستخدم استخراج محتوى من المنصة لنشاط مماثل.',
		TOS_RESPONSIBILITY_TITLE: 'المسؤولية',
		TOS_RESPONSIBILITY_1: 'المستخدم مسؤول عن الضرر المباشر أو غير المباشر الذي من المحتمل أن يتعرض له نتيجة للمعلومات غير الدقيقة و/أو غير الكاملة و/أو المضلة التي يقدمها عند التسجيل أو في حالة عدم تحديث معلوماته، وهو المسؤول  وحده عن العواقب.',
		TOS_RESPONSIBILITY_2: 'المستخدم مسؤول عن كل محتوى ينشره أو يكتبه أو يبثه.',
		TOS_RESPONSIBILITY_3: 'لا يجوز للمستخدم نشر أي محتوى أو الانخراط في أي نشاط أو بث أي شيء أو إنشاء أي حساب مسيء أو إباحي أو عنيف أو تشهيري أو تهديدي أو فاحش أو غير قانوني أو يهدف إلى الترويج أو ارتكاب عمل غير قانوني، بما في ذلك انتهاك حقوق الملكية الفكرية أو حقوق الخصوصية أو حقوق الملكية، أو الافتراء، أو العنصرية، أو كره، أوالمخالفة للأخلاق الحميدة، أوانتهاك المحتوى، ومخالفة النظام العام أو الحقوق، أو انتهاك حقوق المنصة أوسمعتها أوصورتها، أو المحتوى الذي يخالف القانون، ولا سيما ذات الطبيعة الإجرامية، أو يتضمن كلمة السر الخاصة، أو يتضمن عمدًا كلمة سر شخص آخر، أو معلومات شخصية، أو يهدف إلى مخالفة  مثل هذه الشروط، أو تضليل أو خداع، أو خداع الآخرين فيما يتعلق بهويته أو الانتماء إلى منظمة، أو متعلق بأي شيء مخالف لشروط استخدام المنصة أو سياساتها المتعلقة بها.',
		TOS_PRIVACY_TITLE: 'الخصوصية',
		TOS_PRIVACY_1: 'المنصة تحمي المحتوى المباشر والمعلومات باستخدام تقنيات حديثة. بالإضافة إلى ذلك، فإن كلمات السر في الإعدادات الخاصة والاجتماعات تضع التحكم بين يدي المستخدم.',
		TOS_PRIVACY_2: 'نلتزم  باستخدام جميع الوسائل لضمان أمان وخصوصية المحتويات الشخصية للمستخدمين.',
		TOS_PRIVACY_3: 'لا يتم إعادة بيع البيانات الشخصية للمستخدمين ولا يتم نقلها إلى أي أشخاص أو أطراف أو منضمات أو شركات.',
		TOS_PRIVACY_4: 'يمكن للمستخدم الوصول إلى محتوياته الشخصية وتعديلها و تغييرها وتصحيحها وحذفها.',
		TOS_SANCTIONS_TITLE: 'المدة والإنهاء والعقوبات',
		TOS_SANCTIONS_1: 'يتم إبرام هذا العقد لمدة غير محدودة من قبل المستخدم لشروط استخدام المنصة.',
		TOS_SANCTIONS_2: 'إذا لم يحترم المستخدم شروط الاستخدام هذه و/أو ارتكب أي خرق لهذه الشروط، يحق لنا إغلاق حسابه تلقائيًا ، ورفضه في المستقبل، و الوصول إلى جميع أو بعض الخدمات.',
		TOS_MODIFICATION_TITLE: 'تغيير الشروط',
		TOS_MODIFICATION_1: 'لنا الحق في تغيير كل أو جزء من شروط استخدام المنصة.',
		TOS_MODIFICATION_2: 'سنخبر المستخدم بالتغييرات التي يتم إجراؤها على هذه الشروط بمجرد نشرها على المنصة.',
		TOS_LAW_TITLE: 'القانون والاختصاص القضائي',
		TOS_LAW: ' يخضع أي نزاع يتعلق بتشكيل هذه الشروط و/أو إبرامها و/أو تفسيرها و/أو تنفيذها للاختصاص القضائي الحصري للمحاكم الواقعة ضمن اختصاص محكمة الاستئناف بالدار البيضاء بالمغرب.',
		TOS_SIGN_UP: 'أشهد أنني قد قرأت ووافقت على شروط و أحكام الاستخدام.',
		GENERIC_ERROR: 'حدث مشكل غير متوقع.',
		ABOUT_TITLE: 'نبذة',
		ABOUT_USER_FRIENDLY_TITLE: 'سهولة الاستعمال',
		ABOUT_USER_FRIENDLY_1: 'المنصة سهلة الاستعمال، أينما كنت.',
		ABOUT_USER_FRIENDLY_2: 'يمكن للمستخدمين الانتقال فورًا إلى البث المباشر عبر الإنترنت، دون الحاجة إلى تنزيل.',
		ABOUT_SECURE_TITLE: 'الأمان',
		ABOUT_CONTENT_TITLE: 'محتوى نقي',
		NO_MESSAGE: 'ليس هناك رسالة.',
		...
		FROM: 'من',
		SETTINGS_EMAIL_NOTIFICATIONS: ' إشغال إشعارات البريد الإلكتروني',
		SETTINGS_PRIVATE_MESSAGES: 'إشغال المراسالة الخاصة',
		SETTING_UPDATED: 'تم تسجيل الإعداد بنجاح.',
		DELETE_MESSAGE_CONFIRM: 'هل أنتم متأكدون أنكم تريدون حذف هذه الرسالة؟',
		PROFILE_SETTINGS: 'إعدادات الملف الشخصي',
		NETWORK_SETTINGS: 'إعدادات الشبكة',
		DZ_DELETE_ACCOUNT: 'بمجرد حذف الحساب، لا يكمن الرجوع إلى الوراء.',
		DELETE_AVATAR: 'حذف الصورة الشخصية',
		DELETE_AVATAR_CONFIRM: 'هل أنتم متأكدون من حذف الصورة الشخصية؟',
		DELETE: 'حذف',
		...
		JOINED_AT: 'انضم في',
		CONFIRM_TITLE: 'تأكيد',
		DECLINE_CONFIRM: 'هل أنتم متأكدون أنكم تريدون رفض الإرتباط؟',
		DISCONNECT_CONFIRM: 'هل أنتم متأكدون أنكم تريدون قطع الإرتباط؟',
		CANCEL_CONFIRM: 'هل أنتم متأكدون أنكم تريدون إلغاء الإرتباط؟',
		YES: 'نعم',
		LIVE_STREAM: 'بث مباشر',
		START: 'ابتداء',
		TITLE: 'العنوان (واجب)',
		INVALID_TITLE: 'يجب أن لا يقل طوله عن ٣ أحرف.',
		DESCRIPTION: 'الوصف (اختياري)',
		PRIVATE_LIVE: 'خاص (خاص بشبكتكم فقط)',
		CONFERENCE_NOT_FOUND: 'بث غير موجود.',
		CONFERENCE_UNAUTHORIZED: 'ممنوع الوصول إلى هذا البث.',
		CONFERENCE_CLOSED: 'انتهى هذا البث.',
		CONFERENCE_URL_COPIED: 'تم نسخ رابط البث.',
		LEAVING: 'خروج...',
		EMPTY_TIMELINE: 'الجدول الزمني فارغ',
		LOADING_TIMELINE: 'تحميل الجدول الزمني...',
		LIVE: 'مباشر',
		DELETE_CONFERENCE_CONFIRM: 'هل أنتم متأكدون من حذف هذا البث؟',
		CLOSE: 'إغلاق',
		PRPARING_CONFERENCE: 'تحضير البث...',
		NETWORK_UPDATED: 'تم تحديث شبكتم.',
		DELETE_ENTRY_CONFIRM: 'هل أنت متأكدون من حذف هذا العنصر؟',
		LOADING_NOTIFICATIONS: 'تحميل الإشعارات...',
		SIGNIN_VIDEO_CONFERENCING: 'مؤتمرات آمنة',
		SIGNIN_PRIVACY: 'خصوصيتكم هي أولويتنا',
		SIGNIN_PROTECTION: 'نضمن حمايتكم',
		DELETING: 'حذف الحساب...',
		EXTERNAL_API_ERROR: 'فشل تحميل معدات المؤتمر.',
		REPORT: 'إبلاغ',
		BLOCK: 'حجب',
		PROFILE_UNAUTHORIZED: 'ممنوع رؤيت هذا الملف.',
		MESSAGE: 'الرسالة',
		REPORT_SUCCESS: 'لقد تم الإبلاغ عن هذا المستخدم بنجاح.',
		BLOCK_CONFIRM: 'هل أنتم متأكدون من حجب هذا المستخدم؟',
		BLOCK_SUCCESS: 'لقد تم حجب هذا المستخدم بنجاح.',
		UNBLOCK_SUCCESS: 'لقد تم رفع الحجب عن هذ المستخدم بنجاح.',
		UNBLOCK_CONFIRM: 'هل أنتم متأكدون من رفع الحجب عن هذا المستخدم؟',
		UNBLOCK: 'رفع الحجب',
		PUBLIC: 'عمومي',
		PRIVATE: 'خاص',
		MEMBERS: 'الأعضاء',
		NO_MEMBER: 'لا يوجد أعضاء',
		IS_BLACKLISTED: 'لقد تم إغلاق حسابكم.',
		CONTACT: 'اتصال',
		TECHNICAL_ISSUES_TITLE: 'المشاكل التقنية',
		TECHNICAL_ISSUES: 'بالنسبة للمشاكل التقنية، اتصلوا ب admin@wexstream.com.',
		OTHER_REQUESTS_TITLE: 'الطلبات الأخرى',
		OTHER_REQUESTS: 'بالنسبة للطلبات الأخرى، اتصلوا ب contact@wexstream.com.',
		DONATE_TITLE: 'التبرع',
		TERADEV: 'Teradev',
		// DONATE_1: ' هي الشركة التي أسست المنصة. نظرًا لوباء كوفيد ١٩، تم إنشاء هذه المنصة المتخصصة في البث المباشر. تُقدَّم الخدمات مجانا و تتركز المنصة على حفظ أمن وخصوصية المستخدمين. تعتمد المنصة على التبرعات للحفاظ على تشغيلها و ضمان تطويرها واستضافتها وصيانتها.',
		// DONATE_2: 'تم إنشاء المنصة باستخدام أحدث التقنيات و أحسنها فاعلية. يتم استضافة المنصة في خوادم خاصة. تتكلف الشركة التي أسست المنصة بصيانتها، بما في ذلك إصلاح الأخطاء وصيانة قواعد البيانات و الحفاظ على الأمان والخصوصية و حل النزاعات بين المستخدمين وتطبيق شروط الاستخدام و تلبيت جميع الطلبات المتعلقة بالمنصة.',
		// DONATE_3: 'تبلغ تكلفة استضافة وصيانة المنصة حوالي ١٥٠٠ دولار كل عام. لِاستمرار تشغيل المنصة، المرجو تقديم تبرعات للمساعدة على تطويرها واستضافتها وصيانتها.',
		DONATE: 'المرجو تقديم تبرعات للمساعدة على تطويرها واستضافتها وصيانتها.',
		PAYPAL: 'PayPal',
		PATREON: 'Patreon',
		BUY_ME_A_COFFEE: 'Buy Me a Coffee',
		LIBERAPAY: 'Liberapay',
		LANGUAGE: 'اللغة',
		NO_RESULT: 'ليس هناك نتيجة',
		RESET_PASSWORD: 'تغيير كلمة السر',
		PLEASE_WAIT: 'المرجو الانتظار...',
		SIGN_IN_WITH_FACEBOOK: 'دخول عبر Facebook',
		DELETE_ALL_NOTIFICATIONS: 'هل أنتم متأكدون من حذف جميع الإعلانات؟'
		//#endregion
	}
});
