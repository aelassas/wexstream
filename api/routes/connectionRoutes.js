...
// Connect user
routes.route(routeNames.connect)
...
// Get connection ids
routes.route(routeNames.getConnectionIds)
    .get(authJwt.verifyToken, (req, res) => {
        Connection.findOne({ user: req.params.userId, connection: req.params.connectionId })
            .then((senderConnection) => {
                if (!senderConnection) {
...
routes.route(routeNames.delete)
    .delete(authJwt.verifyToken, (req, res) => {
...
// Get connection
routes.route(routeNames.getConnection)
    .get(authJwt.verifyToken, (req, res) => {
...
// Get connections
routes.route(routeNames.getConnections)
    .get(authJwt.verifyToken, async (req, res) => {
        try {
