...
// Accept Connection request Router
routes.route(routeNames.approve).post(authJwt.verifyToken, (req, res) => {
...
// Decline Connection request Router
routes.route(routeNames.decline).post(authJwt.verifyToken, (req, res) => {
    Notification.findById(req.params.notificationId)
        .then(notification => {
            if (notification) {
...
routes.route(routeNames.getNotification).get(authJwt.verifyToken, (req, res) => {
...
// Mark as read router
routes.route(routeNames.markAllAsRead).post(authJwt.verifyToken, (req, res) => {
...
// Delete Notification Router
routes.route(routeNames.deleteAll).delete(authJwt.verifyToken, (req, res) => {
