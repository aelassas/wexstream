...
routes.route(routeNames.deleteSpeakerEntries).delete(authJwt.verifyToken, (req, res) => {
...
routes.route(routeNames.deleteSubscriberEntry).delete(authJwt.verifyToken, (req, res) => {
...
routes.route(routeNames.getEntries).get(authJwt.verifyToken, async (req, res) => {
    try {
