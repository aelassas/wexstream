...
routes.route(routeNames.addMember).post(authJwt.verifyToken, (req, res) => {
    Conference.findById(req.params.conferenceId)
        .then(conf => {
            if (conf) {
...
routes.route(routeNames.removeMember).post(authJwt.verifyToken, (req, res) => {
    Conference.findById(req.params.conferenceId)
        .then(conf => {
            if (conf) {
...
routes.route(routeNames.getConference).get(authJwt.verifyToken, (req, res) => {
    Conference.findById(req.params.conferenceId)
        .populate('speaker')
        .then(conf => {
            if (conf) {
...
routes.route(routeNames.getConferences).get(authJwt.verifyToken, (req, res) => {
...
routes.route(routeNames.getMembers).get(authJwt.verifyToken, async (req, res) => {
    Conference.findById(req.params.conferenceId)
        .populate({
            path: 'members',
...
routes.route(routeNames.close).post(authJwt.verifyToken, (req, res) => {
